...
int main () {
    ...
    // game setting in singleton game struct
    ...
    // load font, set position, scales etc
    ...
    game.background[0].setScale(1.15626, 1.171875);
    game.background[1].setScale(333, 0);
    game.background[2].setScale(666, 0);
    ...
    while (window.isOpen()) {
        ...
        // dont forget to update totoal frames
        game.frames++;
